export default function OurStoryPage() {
  return (
    <div className="min-h-screen max-w-screen bg-[url('/image/red_bg.jpg')] text-[#E8D1A7] bg-cover flex flex-col py-50 lg:px-40 md:px-32 sm:px-20 px-4 space-y-4 lg:space-y-10 ">
      <h1 className="font-bold">Topic : Inclusivity</h1>
      <div>
        หมายถึง การเปิดรับและให้พื้นที่กับทุกคนอย่างเท่าเทียม ไม่แบ่งแยก
        ไม่กีดกัน เพื่อให้ทุกเสียงและตัวตนมีคุณค่า <br />
        ...
        <ul>
          <u>
            <b>เหตุผลหลัก ๆ ที่อาชญากรเลือกกระทำผิดซ้ำ</b>
          </u>
          <br />
        </ul>
        ...
        <q className="font-bold">
          Sometimes, a second chance is all someone needs to change their whole
          story.
        </q>{" "}
        <br />
      ...
      <div>
        ...
        ทำให้ทุกคนมีส่วนร่วมกับเรื่องราวของตัวละครอย่างใกล้ชิด Crim(e)son House
        ไวเคานต์ผู้ล่วงลับ คือ ละครเวทีรูปแบบ{" "}
        <b>Interactive Immersive theatre</b>{" "}
