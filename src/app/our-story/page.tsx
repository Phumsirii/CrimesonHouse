    ...
    <div className="min-h-screen bg-[url('/image/red_bg.jpg')] bg-cover text-[#E8D1A7] max-w-screen flex flex-col py-35 lg:px-40 md:px-32 sm:px-20 px-4 space-y-8 lg:space-y-12">
      ...
      <div>
        ...
        {language === "EN" ? (
          ...
          <p className="mt-2">
            ละครเวทีเรื่อง Crimeson House ไวเคานต์ผู้ล่วงลับ
            มีความตั้งใจที่จะสร้างความเข้าใจเกี่ยวกับการให้โอกาสกับกลุ่มผู้ที่เคยกระทำผิดและได้รับโทษแล้ว
            การเปิดใจให้โอกาสเหล่านี้ไม่ใช่เพียงแค่การให้อภัย
            แต่เป็นการช่วยพวกเขาหาทางออกจากวงจรที่ทำให้พวกเขาตัดสินใจผิดพลาดในอดีต
            โดยให้การสนับสนุนที่เหมาะสมในการฟื้นฟูและพัฒนาคุณภาพชีวิต
            เพื่อที่พวกเขาจะสามารถกลับมามีชีวิตที่มีคุณค่าและเป็นส่วนหนึ่งที่ดีของสังคมได้
          </p>
        )}
      </div>
