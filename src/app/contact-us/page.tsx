...
export default function ContactUsPage() {
  return (
    <div className="max-h-screen max-w-screen flex flex-col py-24 lg:px-40 md:px-32 sm:px-20 px-4 space-y-4 lg:space-y-10 ">
      ...
      <div className="flex flex-row text-xl lg:text-2xl">
        <div className="flex flex-col space-y-10 lg:space-y-16 text-white">
          <Link
