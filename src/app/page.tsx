  ...
  return (
    <div className="max-h-screen max-w-screen">
      ...
      <div className="grid grid-cols-9 h-12 border-b m-10 text-m">
        <div className="col-span-5 flex justify-start p-2 text-2xl text-bold">HOME</div>
      ...
      <div className="flex flex-col py-40 h-full justify-start text-7xl text-center items-center text-3xl">
